...
extern "C" __global__ void __launch_bounds__(1024) fused_reshape_cast_pad_kernel(half* __restrict__ T_pad, float* __restrict__ p0) {
...
void _launch_fused_reshape_cast_pad_kernel(float* __restrict__ inp, half* __restrict__ outPad, cudaStream_t stream) {
  fused_reshape_cast_pad_kernel<<<dim3(250, 1, 1), dim3(1024, 1, 1), 0, stream>>>(outPad, inp);
}
...
void _launch_fused_gemm1_kernel(half* __restrict__ inp, half* __restrict__ w, half* __restrict__ g, half* __restrict__ b, half* __restrict__ outGemm, cudaStream_t stream) {
  fused_gemm1_kernel<<<dim3(10000,1,1), dim3(32,4,2), 0, stream>>>(inp, w, g, b, outGemm);
}
...
void _launch_fused_gemm_bn_relu_max_tile_kernel(half* __restrict__ inp, half* __restrict__ w, half* __restrict__ g, half* __restrict__ b, half* __restrict__ outGemm, cudaStream_t stream) {
  // fused_gemm_bn_relu_max_tile_kernel<<<dim3(10000,1,1), dim3(32,4,2), 0, stream>>>(inp, w, g, b, outGemm);
  fused_gemm_bn_relu_max_tile_v2_kernel<<<dim3(10000,1,1), dim3(32,4,2), 0, stream>>>(inp, w, g, b, outGemm);
}
...
void _launch_fused_gemm2_kernel(half* __restrict__ inp, half* __restrict__ w, half* __restrict__ g, half* __restrict__ b, half* __restrict__ outGemm, cudaStream_t stream) {
  fused_gemm2_kernel<<<dim3(10000,1,1), dim3(32,2,4), 0, stream>>>(inp, w, g, b, outGemm);
}
...
void _launch_fused_gemm_bn_relu_max_kernel(half* __restrict__ inp, half* __restrict__ w, half* __restrict__ g, half* __restrict__ b, float* __restrict__ outGemm, cudaStream_t stream) {
  // fused_gemm_bn_relu_max_kernel<<<dim3(10000,1,1), dim3(32,2,4), 0, stream>>>(inp, w, g, b, outGemm);
  fused_gemm_bn_relu_max_v2_kernel<<<dim3(10000,1,1), dim3(32,2,4), 0, stream>>>(inp, w, g, b, outGemm);
}

/////////////////////////////////////////////////////////////////////////////////////////
void fused_reshape_cast_pad(float* inp, half* outPad, cudaStream_t stream) {
  _launch_fused_reshape_cast_pad_kernel(inp, outPad, stream);
